...
import org.springframework.samples.maderas.auth.payload.request.LoginRequest;
import org.springframework.samples.maderas.auth.payload.request.SignupRequest;
import org.springframework.samples.maderas.auth.payload.response.JwtResponse;
import org.springframework.samples.maderas.auth.payload.response.MessageResponse;
import org.springframework.samples.maderas.configuration.jwt.JwtUtils;
import org.springframework.samples.maderas.configuration.services.UserDetailsImpl;
