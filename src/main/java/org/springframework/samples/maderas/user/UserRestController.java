 ...
 */
package org.springframework.samples.maderas.user;
...
import org.springframework.samples.maderas.util.RestPreconditions;
...
class UserRestController {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<MessageResponse> delete(@PathVariable("userId") int id) throws AccessDeniedException {
		RestPreconditions.checkNotNull(userService.findUserbyId(id), "User", "ID", id);
